...
function DeleteCategoryConfirmModal({
  ...
  return (
    <div
      ...
      role="dialog"
    >
      <div className="w-full max-w-lg rounded-3xl border border-[#E5E7EB] bg-white shadow-[0_28px_80px_rgba(220,38,38,0.14)]">
        ...
        <div className="space-y-5 px-6 py-6 sm:px-8">
          ...
          <div className="rounded-2xl border border-[#E5E7EB] bg-[#F8FAF7] px-4 py-4">
