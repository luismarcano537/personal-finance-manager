 ...
 * button on the right. Mobile-first and overflow-safe — reads like a personal
 * finance app, not an admin console.
 */
function MobileTopbar({ onMenuClick, userName }: MobileTopbarProps) {
  return (
    <header className="flex items-center justify-between gap-3 border-b border-brand-border bg-brand-surface px-4 py-3 lg:hidden">
      ...
      <button
        aria-label={userName ? `Menu de ${userName}` : 'Abrir menu'}
